...
class Appgenix_Contact_Info_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'wphex_contact_info',
			esc_html__( 'wphex: Contact Info', 'appgenix-master' ),
...
if ( ! function_exists( 'Appgenix_Contact_Info_Widget' ) ) {
	function Appgenix_Contact_Info_Widget() {
		register_widget( 'Appgenix_Contact_Info_Widget' );
	}

	add_action( 'widgets_init', 'Appgenix_Contact_Info_Widget' );
}
